    ...
    echo "<div class='col-md-12'>
          ...
          <div class='col-md-12'>
                  ...
                  <input type='hidden' name='id' value='$nourut'>";
                    ...
                    echo "</td></tr>
                    <tr><th scope='row'>Kode Kecamatan</th>                <td><input type='text' class='form-control' name='b' readonly required value='$no'></td></tr>";
                    echo "
                    ...
                    <tr><th scope='row'>Nama Kecamatan</th>  <td><input type='text' class='form-control' name='c' required></td></tr>
