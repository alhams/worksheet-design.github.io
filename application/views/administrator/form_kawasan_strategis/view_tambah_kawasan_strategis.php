    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Kawasan Strategis</h3>
                </div>
              <div class='box-body'>";
          ...
          <div class='col-md-12'>
                  ...
                  <input type='hidden' name='id' value='$nourut'>";
                    ...
                    echo "</td></tr>
                    <tr><th scope='row'>Kode Kawasan</th>                <td><input type='text' class='form-control' name='b' readonly required value='$no'></td></tr>
                    <tr><th scope='row'>Kawasan Strategis</th>  <td><input type='text' class='form-control' name='c' required></td></tr>
